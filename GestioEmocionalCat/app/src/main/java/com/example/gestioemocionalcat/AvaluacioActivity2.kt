...
class AvaluacioActivity2 : AppCompatActivity() {

    lateinit var respostes: IntArray

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_avaluacio2)
    ...
    private fun nextQuestion(resposta: Int) {
        respostes[1] = resposta

        startActivity(Intent(this, AvaluacioActivity3::class.java).apply {
